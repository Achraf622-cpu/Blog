                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <h2 class="text-2xl font-bold text-blue-400"><?php echo $row['titre']; ?></h2>
                            <?php if (!empty($row['img'])): ?>
                                <img src="<?php echo $row['img']; ?>" alt="<?php echo $row['titre']; ?>" class="w-full rounded-lg mt-4">
                            <?php endif; ?>
                            <p class="text-gray-400 mt-4"><?php echo $row['para']; ?></p>
                            <p class="text-gray-500 text-sm mt-2">Tags: <?php echo $row['tags'] ?: 'None'; ?></p>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
